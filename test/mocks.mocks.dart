...
class MockMovieRepository extends _i1.Mock implements _i10.MovieRepository {
  ...
  @override
  _i8.Future<List<_i11.Movie>> getNowPlayingMovies({int? page = 1}) =>
      (super.noSuchMethod(
        Invocation.method(
          #getNowPlayingMovies,
          [],
        ...
        returnValue: _i8.Future<List<_i11.Movie>>.value(<_i11.Movie>[]),
      ) as _i8.Future<List<_i11.Movie>>);

  @override
  _i8.Future<List<_i11.Movie>> searchMovies(
    String? query, {
    int? page = 1,
  }) =>
      (super.noSuchMethod(
